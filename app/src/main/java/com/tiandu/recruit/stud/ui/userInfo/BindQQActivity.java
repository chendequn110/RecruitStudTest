...
public class BindQQActivity extends BaseActivity{
    ...
    @OnClick(R.id.btnSubmit) void submitClick(){
        ...
        showloginDialog("");
        Api.getInstance()
                .movieService.upDataUserInfo(C.USER_UPDATAUSERINFO_PATH,"Edit", SpUtil.getMemberID(),"","","","",qq,"","","","","","","",SpUtil.getToken())
    ...
    protected int getLayoutRes() {
        return R.layout.activity_bindqq;
    }
